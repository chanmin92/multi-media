...
import os
import sys
sys.path.append('/home/nlpgpu2/data/cm/show-attend-and-tell-tensorflow/coco-caption/')
...
def evaluate(data_path='./data', split='val', get_scores=False):
    # reference_path = os.path.join(data_path, "%s/toy_%s.references.pkl" %(split, split))
