...
class CaptioningSolver(object):
    def __init__(self, model, data, val_data, **kwargs):
        ...
        self.log_path = kwargs.pop('log_path', './log_default_highway/')
    ...
    def train(self):
        ...
        for caption in captions:
            fw_lm_id = caption[1:]
            fw_lm_id = np.append(fw_lm_id,[0])
            fw_lm_ids.append(fw_lm_id)

        fw_lm_ids = np.asarray(fw_lm_ids)
